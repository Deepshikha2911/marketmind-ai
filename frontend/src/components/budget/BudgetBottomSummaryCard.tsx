...
import type { BudgetBottomSummary } from "@/lib/budget-data";
import { formatCurrency, formatPercent } from "@/lib/utils";

type BudgetBottomSummaryCardProps = {
  summary: BudgetBottomSummary;
};

export function BudgetBottomSummaryCard({ summary }: BudgetBottomSummaryCardProps) {
  const metrics = [
    {
    ...
    {
      label: "Estimated Monthly Revenue Increase",
      value: `+${formatCurrency(summary.estimatedMonthlyRevenueIncrease)}`,
    },
    {
      label: "Budget Savings",
      value: formatCurrency(summary.budgetSavings),
    },
    {
      label: "Confidence",
      ...
      <div className="relative">
        <div className="mb-6 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-400">AI-generated budget optimization results</p>
          </div>
        </div>
